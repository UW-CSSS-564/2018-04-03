...
1. Consider a rare name - what is the probability on days in years in which there is no sample. How does that affect the analysis?
      What would you do about it?
2. How would you calculate p(age | name) if you don't know the sex?
